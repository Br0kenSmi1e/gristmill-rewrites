//! Structural validation for symbolic computations and protected outputs.

use super::StateError;
use crate::repr::{Computation, RangeId, TensorDef, TensorId};
use std::collections::{BTreeMap, BTreeSet};

pub(super) fn validate_computation(
...
pub(super) fn validate_protected_outputs(
    computation: &Computation,
